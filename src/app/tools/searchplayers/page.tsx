...
import { Button, Input, InputGroup, InputLeftElement, InputRightElement, Menu, MenuButton, MenuItem, MenuList, Spinner } from "@chakra-ui/react";
      ...
      <div className="flex justify-center bg-gray-100 ">
        <PageContainer>
          <div className="rounded-ms flex flex-col border border-black border-opacity-20 bg-white p-4">
            <h1 className="text-page-title font-semibold">Search Players</h1>

            <div className="w-full flex py-4 justify-center">
              <div className='flex flex-col gap-2 w-full xl:w-1/2'>
                <div className="font-bold">Start typing a player name:</div>
